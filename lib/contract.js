...
export const LOCALHOST_ID = 31337; // Hardhat local network
...
export const isLocalhostChain = (chainId) => chainId === LOCALHOST_ID;
...
export const getSigner = async () => {
  ...
  try {
    ...
    // For localhost and other networks, return unwrapped signer
    return signer;
  } catch {}
  return signer;
};
